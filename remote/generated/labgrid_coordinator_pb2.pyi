...
class ClientInMessage(_message.Message):
    ...
    def __init__(
        self,
        sync: _Optional[_Union[Sync, _Mapping]] = ...,
        startup: _Optional[_Union[StartupDone, _Mapping]] = ...,
        subscribe: _Optional[_Union[Subscribe, _Mapping]] = ...,
    ) -> None: ...
...
class StartupDone(_message.Message):
    ...
    name: str
    def __init__(
        self, version: _Optional[str] = ..., name: _Optional[str] = ...
    ) -> None: ...
...
class ClientOutMessage(_message.Message):
    ...
    def __init__(
        self,
        sync: _Optional[_Union[Sync, _Mapping]] = ...,
        updates: _Optional[_Iterable[_Union[UpdateResponse, _Mapping]]] = ...,
    ) -> None: ...
...
class UpdateResponse(_message.Message):
    ...
    def __init__(
        self,
        resource: _Optional[_Union[Resource, _Mapping]] = ...,
        del_resource: _Optional[_Union[Resource.Path, _Mapping]] = ...,
        place: _Optional[_Union[Place, _Mapping]] = ...,
        del_place: _Optional[str] = ...,
    ) -> None: ...
...
class ExporterInMessage(_message.Message):
    ...
    def __init__(
        ...
        resource: _Optional[_Union[Resource, _Mapping]] = ...,
        startup: _Optional[_Union[StartupDone, _Mapping]] = ...,
        response: _Optional[_Union[ExporterResponse, _Mapping]] = ...,
    ) -> None: ...
...
class Resource(_message.Message):
    ...
    class ParamsEntry(_message.Message):
        ...
        def __init__(
            self,
            key: _Optional[str] = ...,
            value: _Optional[_Union[MapValue, _Mapping]] = ...,
        ) -> None: ...
    ...
    def __init__(
        self,
        path: _Optional[_Union[Resource.Path, _Mapping]] = ...,
        cls: _Optional[str] = ...,
        params: _Optional[_Mapping[str, MapValue]] = ...,
        extra: _Optional[_Mapping[str, MapValue]] = ...,
        acquired: _Optional[str] = ...,
        avail: bool = ...,
    ) -> None: ...
...
class ExporterOutMessage(_message.Message):
    ...
    def __init__(
        ...
        set_acquired_request: _Optional[
            _Union[ExporterSetAcquiredRequest, _Mapping]
        ] = ...,
    ) -> None: ...
...
class GetPlacesResponse(_message.Message):
    ...
    def __init__(
        self, places: _Optional[_Iterable[_Union[Place, _Mapping]]] = ...
    ) -> None: ...
...
class Place(_message.Message):
    ...
    def __init__(
        ...
        matches: _Optional[_Iterable[_Union[ResourceMatch, _Mapping]]] = ...,
        acquired: _Optional[str] = ...,
        acquired_resources: _Optional[_Iterable[str]] = ...,
        allowed: _Optional[_Iterable[str]] = ...,
        created: _Optional[float] = ...,
        changed: _Optional[float] = ...,
...
class AddPlaceAliasRequest(_message.Message):
    ...
    alias: str
    def __init__(
        self, placename: _Optional[str] = ..., alias: _Optional[str] = ...
    ) -> None: ...
...
class SetPlaceTagsRequest(_message.Message):
    ...
    tags: _containers.ScalarMap[str, str]
    def __init__(
        self, placename: _Optional[str] = ..., tags: _Optional[_Mapping[str, str]] = ...
    ) -> None: ...
...
class SetPlaceCommentRequest(_message.Message):
    ...
    comment: str
    def __init__(
        self, placename: _Optional[str] = ..., comment: _Optional[str] = ...
    ) -> None: ...
...
class ReleasePlaceRequest(_message.Message):
    ...
    fromuser: str
    def __init__(
        self, placename: _Optional[str] = ..., fromuser: _Optional[str] = ...
    ) -> None: ...
...
class AllowPlaceRequest(_message.Message):
    ...
    user: str
    def __init__(
        self, placename: _Optional[str] = ..., user: _Optional[str] = ...
    ) -> None: ...
...
class CreateReservationRequest(_message.Message):
    ...
    class FiltersEntry(_message.Message):
        ...
        def __init__(
            self,
            key: _Optional[str] = ...,
            value: _Optional[_Union[Reservation.Filter, _Mapping]] = ...,
        ) -> None: ...
    ...
    def __init__(
        self,
        filters: _Optional[_Mapping[str, Reservation.Filter]] = ...,
        prio: _Optional[float] = ...,
    ) -> None: ...
...
class CreateReservationResponse(_message.Message):
    ...
    def __init__(
        self, reservation: _Optional[_Union[Reservation, _Mapping]] = ...
    ) -> None: ...
...
class Reservation(_message.Message):
    ...
    def __init__(
        ...
        prio: _Optional[float] = ...,
        filters: _Optional[_Mapping[str, Reservation.Filter]] = ...,
        allocations: _Optional[_Mapping[str, str]] = ...,
        created: _Optional[float] = ...,
...
class GetReservationsResponse(_message.Message):
    ...
    def __init__(
        self, reservations: _Optional[_Iterable[_Union[Reservation, _Mapping]]] = ...
    ) -> None: ...
